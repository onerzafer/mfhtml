...
exports.generateManifest = dom => {
    ...
    const manifest = utils.cleanObject({
        ...
        extends: utils.getAttr(_$('head meta[export]'), 'extends'),
        route: utils.getAttr(_$('head meta[export-as]'), 'export-as'),
        ...
        publics: Array.from(_$$('[public]')).map(elem => elem.getAttribute('public') || elem.tagName)
    });
